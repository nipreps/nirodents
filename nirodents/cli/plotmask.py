...
def get_parser():
    ...
    parser.add_argument("-b", "--base-image", type=Path, required=True,
                        help="The base image for overlay.")
    parser.add_argument("-m", "--mask-image", type=Path, required=True,
                        help="The mask image for overlay.")
    parser.add_argument("-o", "--output", type=Path,
                        help="The location of output file.")
    parser.add_argument("-s", "--plot-sagittal", type=int, default=0, choices=[0,1],
...
def main():
    ...
    #call function
    viz.plot_mosaic(img=opts.base_image, overlay_mask=opts.mask_image,
                    plot_sagittal=bool(opts.plot_sagittal), ncols=opts.columns, 
